...
document.getElementById("searchInput").addEventListener("input", setDataForSearch);
...
function setDataForSearch() {
  google.script.run.withSuccessHandler(function (dataReturned) {
    ...
    if (searchInput === "") {
      var resultsArray = dataReturned;
    } else {
      resultsArray = dataReturned.filter(function (r) {
        return r.name.indexOf(searchInput) !== -1;
      });
    }
