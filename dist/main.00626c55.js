...
function addItemsToSearch(data) {
  data.forEach(function (handcraft) {
    ...
    template.querySelectorAll(".edit-collapsible").forEach(function (el) {
      dataset.slf = handcraft.slf;
    });
    template.querySelector(".recieve-collapsible").dataset.slf = handcraft.slf;
    template.querySelector(".sale-collapsible").dataset.slf = handcraft.slf;
    template.querySelector(".inventoryCheck-collapsible").dataset.slf = handcraft.slf;
  ...
  data.forEach(function (handcraft) {
    ...
    var imageSource = "https://drive.google.com/uc?export=view&id=" + handcraft.imageId;
    template.querySelector("#item-image").src = imageSource;
    template.querySelector(".edit-cards").dataset.slf = handcraft.slf;
    template.querySelector(".recieve-cards").dataset.slf = handcraft.slf;
    template.querySelector(".sale-cards").dataset.slf = handcraft.slf;
    template.querySelector(".inventoryCheck-cards").dataset.slf = handcraft.slf;
...
function clickEventHandler(e) {
  if (e.target.matches(".edit-collapsible")) {
    document.getElementById("edit-slf").value = e.target.dataset.slf; // console.log(e.currentTarget.dataset.slf);
