...
function clickEventHandler(e) {
  if (e.target.matches(".edit-button")) {
    ...
    google.script.run.withSuccessHandler(function (editHandcraft) {
      ...
      $("#edit-company")[0].value = editHandcraft.company;
      $("#edit-company")[0].value = editHandcraft.company;
      $("#edit-company")[0].value = editHandcraft.creole;
      $("#edit-company")[0].value = editHandcraft.description;
      $("#edit-company")[0].value = editHandcraft.tags;
      $("#edit-company")[0].value = editHandcraft.notes;
