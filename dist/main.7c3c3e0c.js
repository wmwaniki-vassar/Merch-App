...
function editHandcraft() {
  ...
  editHandcraftBySlf.creole = $("#edit-creole")[0].value;
  ...
  google.script.run.withSuccessHandler(function () {}).editHandcraftBySlf(slf, editedHandcraft);
}
  ...
  if (e.target.matches(".edit-button")) {
    ...
    google.script.run.withSuccessHandler(function (editHandcraft) {
      ...
      if (document.documentElement.clientWidth > 600) {
        document.getElementById("edit-image").classList.add("");
      }
