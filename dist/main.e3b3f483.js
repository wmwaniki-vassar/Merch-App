...
function addItemsToSearch(data) {
  ...
  sampleData.forEach(function (item) {
    template.querySelector('#item-slf').textContent = item.SLF;
    template.querySelector('#item-name').textContent = item[3].Name;
    template.querySelector('#item-material').textContent = item[3].Material;
    template.querySelector('#item-stock').textContent = item[3].Stock;
    template.querySelector('#item-price').textContent = item[3].Price;
