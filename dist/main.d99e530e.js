...
function clickEventHandler(e) {
  if (e.target.matches(".edit-collapsible") || e.target.matches(".edit-cards")) {
    document.getElementById("edit-slf").value = "test"; //e.target.dataset.slf;

    console.log("updated slf");
  }
}
},{}]},{},["d6sW"], null)