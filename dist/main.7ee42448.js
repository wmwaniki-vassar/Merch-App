...
var sampleData = [{
  ...
  style: '074-018',
  notes: '',
  imageId: '1xptb5SvDiRqfuLSOmlwFzBSstLs3YF5P'
}, {
  slf: 'PM-10',
  name: '',
  creole: '',
  ...
  style: '016-003',
  notes: '',
  imageId: '111ePgIDv5Nd-Lge4eoIoCDeI9iaGVX-9'
}, {
  slf: 'PM-11',
  name: 'Elephant ',
  creole: 'created',
  ...
  tags: 'Elephant ',
  company: 'C',
  style: 'Frantz Janvier/016-003',
  notes: '',
  imageId: '111ePgIDv5Nd-Lge4eoIoCDeI9iaGVX-9'
}]; //load data when page loads

document.addEventListener('DOMContentLoaded', addItemsToSearch(sampleData));
