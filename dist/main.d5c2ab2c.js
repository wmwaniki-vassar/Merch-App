...
function addItemsToSearch(data) {
  data.forEach(function (handcraft) {
    ...
    template.querySelector("#item-image").src = imageSource; // template.querySelector(".button").dataset.slf = handcraft.slf;

    template.querySelector("#recieve-button");
    template.querySelector("#sale-button");
    template.querySelector("#inventoryCheck-button");
  ...
  data.forEach(function (handcraft) {
    ...
    template.querySelector(".button").dataset.slf = handcraft.slf;
