...
function editHandcraft() {
  ...
  var editedHandcraft = {};
  editedHandcraft.name = "x";
  editedHandcraft.creole = "x";
  editedHandcraft.material = "x";
  editedHandcraft.description = "x";
  editedHandcraft.tags = "x";
  editedHandcraft.company = "x";
  editedHandcraft.style = "x";
  editedHandcraft.notes = "x";
  editedHandcraft.retail = "x"; // editedHandcraft.name = $("#edit-name")[0].value;
  ...
  // editedHandcraft.tags = $("#edit-tags")[0].value;
