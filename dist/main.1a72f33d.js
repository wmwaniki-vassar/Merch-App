...
function editHandcraft() {
  ...
  var editChipElement = document.getElementById("edit-tags");
  var chip = M.Chips.init(editChipElement);
  var chipsData = chip.chipsData.map(function (c) {
    return c.tag;
  });
  editedHandcraft.tags = chipsData.join(", ");
  console.log(chip.chipsData);
  console.log(editChipElement);
